...
export default function Header({ setSidebarOpen }: HeaderProps) {
  ...
  // ✅ Log session data to check if user info is loaded
  ...
  return (
    <header className="sticky top-0 z-20 flex items-center h-15 px-1 sm:px-6 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 shadow-sm transition-colors">
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            >
              {avatar ? (
                ...
                <div className="w-9 h-9 bg-emerald-500 rounded-full flex items-center justify-center text-white font-medium transition">
                  {userInitial}
                </div>
              )}
